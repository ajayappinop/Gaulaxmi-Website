...
export function AuthForm() {
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-cream">
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full bg-black/20 border border-white/10 rounded-xl py-3 pl-10 pr-10 outline-none focus:border-gold/50 focus:bg-black/40 transition-all"
            ...
            >
              ...
              <label className="flex items-start gap-2 cursor-pointer mt-2 group">
                <div className="relative flex items-center justify-center shrink-0 mt-0.5">
                  ...
                  />
                  <svg className="absolute w-3 h-3 text-bark top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none opacity-0 peer-checked:opacity-100 transition-opacity" viewBox="0 0 14 14" fill="none">
